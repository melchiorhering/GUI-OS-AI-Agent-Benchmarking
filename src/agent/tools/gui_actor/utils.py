            ...
            json.dump(
                {
                    ...
                    "data_processor_config": {
                        k: v for k, v in data_processor.__dict__.items() if is_json_serializable(v)
                    },
                    "image_processor_config": {
                        k: v for k, v in data_processor.image_processor.__dict__.items() if is_json_serializable(v)
                    },
...
def draw_point(image: Image.Image, point: list, color=None):
    ...
    overlay_draw.rectangle([x - radius, y - radius, x + radius, y + radius], fill=color)
